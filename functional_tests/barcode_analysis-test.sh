...
this_program_name="barcode_analysis-test.sh"
...
${this_program_name}: run integration/regression tests for barcode_analysis 

Usage:
    ${this_program_name} [-h] [-v] -p program -d test_data_dir 

Example:
    ${this_program_name} -p bin/barcode_analysis -d data/tests
